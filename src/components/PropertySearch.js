      ...
      <form>
        <div className="row">
          <div className="form-group col-lg-2 col-md-6 col-sm-12 col-xs-12">
            ...
            <select aria-label ="type select" className="form-select" ref={typeRef}>
          ...
          <div className="form-group col-lg-2 col-md-6 col-sm-12 col-xs-12">
            ...
            <select aria-label ="price select" className="form-select" ref={priceRef}>
          ...
          <div className="form-group col-lg-2 col-md-6 col-sm-12 col-xs-12">
            ...
            <select aria-label ="bedroom select" className="form-select" ref={bedroomRef}>
              <option value="0">Any</option>
          ...
          <div className="form-group col-lg-2 col-md-6 col-sm-12 col-xs-12">
            ...
            <select aria-label ="bathroom select" className="form-select" ref={bathroomRef}>
              <option value="0">Any</option>
              <option value="1">Minimum 1</option>
              <option value="2">Minimum 2</option>
              <option value="3">Minimum 3</option>
          ...
          <div className="form-group col-lg-2 col-md-6 col-sm-12 col-xs-12">
            ...
            <select aria-label ="garden select" className="form-select" ref={gardenRef}>
              <option value="0">Any</option>
          ...
          <div className="form-group col-lg-2 col-md-6 col-sm-12 col-xs-12">
            <label htmlFor="status">
              <FontAwesomeIcon icon={faCircleDot} /> Status
            </label>
            <select aria-label ="status select"  className="form-select" ref={statusRef}>
              <option value="ANY">Any</option>
